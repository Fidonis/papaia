...
#
# Files that are ALWAYS overwritten on each sync (auto-generated by
# setup-papaia.sh; secrets must stay in sync with service .env files):
#
...
# These are auto-generated by setup-papaia.sh and must stay in lockstep
